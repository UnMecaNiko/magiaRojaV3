...
| X | `$130` | **505 mm** |
| Y | `$131` | **490 mm** |
| Z | `$132` | ⏳ PENDIENTE de medir (hoy 200 por defecto) |
...
- Los soft limits (`$20=1`) protegen contra exceder estos valores; son correctos para X/Y. **Z aún NO** (su `$132` sigue en el default de 200 mm, sin medir).
