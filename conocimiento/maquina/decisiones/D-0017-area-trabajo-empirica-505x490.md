...
| X | `$130` | **505 mm** |
| Y | `$131` | **490 mm** |
| Z | `$132` | **80 mm** (recorrido real medido 85 mm, límite con ~5 mm de margen) |
...
- Los soft limits (`$20=1`) protegen contra exceder estos valores en los tres ejes: X (505), Y (490) y **Z (80 mm; recorrido real 85 mm con margen)**.
